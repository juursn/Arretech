			...
			<aside className="flex flex-col items-center w-full mt-15">
				<div className="flex flex-col gap-15 w-[95%]">
					...
					<div className="flex flex-col items-center justify-center">
						...
						<div className="relative flex sm:flex-col gap-5 mt-15 overflow-x-auto scroll-smooth w-full" ref={carrosselRef} onScroll={verificarScroll}>
							<Cards
								imagem={inteligencia}
						...
						<button className="absolute flex right-10" onClick={irParaDireita}><CaretRightIcon /></button>
						{showLeft && (<button className="absolute flex left-10" onClick={irParaEsquerda}><CaretLeftIcon /></button>)}
					</div>
