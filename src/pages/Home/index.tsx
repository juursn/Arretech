...
import { painel, inteligencia, agil, auto, suporte, nvidia, pesquisaai, processamneto, chatbot, visao, analise, business, seguranca, coment, img3} from "../../assets"
        ...
        <body className="w-full">
            <header className=" flex flex-col items-center relative w-full mt-7">
                <nav className="flex justify-center w-[95%]">
                    <img src={painel} alt="painel" className="w-full h-[650px] rounded-4xl sm:h-[550px]" />
                    <NavBar />
                </nav>
            </header>
            ...
            <aside className="flex flex-col items-center w-full mt-15">
                <div className="flex flex-col gap-15 w-[95%]">
                    <div className="flex flex-col items-center py-7 gap-10 border border-[#2F91FF] rounded-lg">
                        <h1 className="text-4xl font-bold bg-gradient-to-r from-[#4FB6FF]
                        via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">Nossa missão</h1>
                        <p className="w-[80%] text-center text-xl font-light">Democratizar o acesso à Inteligência Artificial, desenvolvendo soluções inovadoras que empoderam empresas a alcançar novos patamares de eficiência e competitividade no mercado digital.</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <div className="w-full ">
                            <h1 className="text-4xl font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">O que oferecemos ?</h1>
                        </div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col items-center gap-10">
                            <h1 className="text-4xl text-center font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">Nossa Trajetória no Ecossistema </h1>
                            <p className="w-[70%] text-center text-xl font-normal">Construindo parcerias fortes e levando presença arretada para os palcos da inovação tecnológica.</p>
                        ...
                        <div className="flex flex-col items-center gap-7 w-full mt-15">
                            <h3 className="text-lg font-normal bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent border border-[#235FC7] py-1 px-3 rounded-full transition-transform duration-300 hover:scale-110 cursor-default">MARCANDO PRESENÇA</h3>
                    ...
                    <div className="flex flex-col items-center">
                        <h1 className="text-4xl text-center font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">Conheça Nossos Serviços</h1>
                    ...
                    <div>
                        <h1 className="text-4xl text-center font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">O que Nossos Clientes Dizem</h1>
                        <div className="flex flex-col gap-5 mt-15 max-w-[400px] md:grid grid-cols-2 min-w-[658px]  lg:grid-cols-3 min-w-full">
                            <Cards3
                    ...
                    <div className="flex flex-col items-center gap-10">
                        <h1 className="text-4xl text-center font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">Pronto para Revolucionar seu Negócio?</h1>
                        <p className="text-center text-xl font-light">Entre em contato conosco e descubra como a IA pode transformar seus processos e impulsionar seus resultados.</p>
                        <div className="flex justify-center gap-5">
                            <button className="py-1 px-4 text-white bg-[#2F91FF] rounded-lg hover:bg-[#1e70d2] cursor-pointer">Agendar consulta</button>
                            <button className="py-1 px-4 border rounded-lg hover:bg-[#1e70d2] border-[#2F91FF] font-light cursor-pointer">Solicitar orçamento</button>
                        </div>
                    </div>
                    <div className="flex flex-col gap-10">
                        <h1 className="text-4xl font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">Notícias Recentes</h1>
                    ...
                    <div className="flex flex-col gap-10">
                        <h1 className="text-4xl font-bold bg-gradient-to-r from-[#4FB6FF] via-[#235FC7] to-[#3E5BDD] bg-clip-text text-transparent">FAQ</h1>
